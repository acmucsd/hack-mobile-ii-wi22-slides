...
- Current mobile dev landscape: 😕
  ...
  - <b>iOS</b> - limited to Mac, which is 💸
...
## We'll be going over some slightly more advanced concepts

1. TODO
2. EVERYTHING AFTER THIS LINE IS A TODO
...
- `📂 screens` contains a layout/screen of the app
...
## **Let's write our first component, `Note.js`! 👨‍💻**
...
## **Now let's fill out `EditNote.js` 👨‍💻**
...
## **Let's modify `App.js` to support navigation 👨‍💻**
